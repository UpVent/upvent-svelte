        ...
        <div class="col">
            <div class="card mb-4 rounded-3 shadow-sm border-0">
                <div class="card-header border-0 py-3">
                    <p class="h4 my-0 fw-normal">Individual</p>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mt-3 mb-4">
                        ...
                        <li class="text-wrap text-break"><CheckCircle/> Acceso a documentación y tutoriales de UpVent</li>
            ...
            <div class="card mb-4 rounded-3 shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mt-3 mb-4">
                        ...
                        <li class="text-wrap text-break"><CheckCircle/> Página web + CMS + CRM</li>
                        <li class="text-wrap text-break"><CheckCircle/> Acceso a documentación avanzada de UpVent</li>
            ...
            <div class="card mb-4 rounded-3 shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mt-3 mb-4">
                        ...
                        <li class="text-wrap text-break"><CheckCircle/> Acceso a documentación avanzada de UpVent</li>
                        <li class="text-wrap text-break"><CheckCircle/> Soporte técnico 24/5 + Peritaje gratuito</li>
                        <li class="text-wrap text-break"><CheckCircle/> Servidores + Weeping Moon Hardening</li>
                        <li class="text-wrap text-break"><StarFill/> <strong>Paquete negociable contactando a ventas.</strong></li>
                    </ul>
                    <small class="text-muted">* Servidor Individual: 1GB RAM, 25GB SSD, 1 vCPU</small>
