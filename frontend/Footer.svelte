...
<footer class="text-center text-muted bg-light-gray">
        ...
        <section class="mt-5">
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    <div class="container">
                        <img class="img-fluid mb-1" width="116" height="47" src="images/logo-grey.png" alt="UpVent Logo" loading="lazy"/>
                    </div>
    ...
    <section class="text-center p-3">
        ...
        <a href="https://github.com/UpVent/upvent.codes/issues/new">Reportar un problema con este sitio</a>
    </section>
</footer>
