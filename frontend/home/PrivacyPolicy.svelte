<section class="container">
    ...
    <hr>
    <p class="lead">UpVent Technologies opera el sitio web https://upvent.codes, que proporciona el SERVICIO.</p>
    <p class="text-muted small">
        Esta página se utiliza para informar a los visitantes del sitio web sobre nuestras políticas con la recopilación, el uso y la divulgación de información personal si alguien decide utilizar nuestro Servicio, el sitio web de UpVent.
    </p>

    <p class="text-muted small">
        Si elige utilizar nuestro Servicio, acepta la recopilación y el uso de información en relación con esta política. La Información Personal que recopilamos se utiliza para proporcionar y mejorar el Servicio. No usaremos ni compartiremos su información con nadie, excepto como se describe en esta Política de privacidad. Nuestra Política de Privacidad fue creada con la ayuda del Generador de Plantillas de Política de Privacidad.
        Los términos utilizados en esta Política de privacidad tienen los mismos significados que en nuestros Términos y condiciones, a los que se puede acceder en <a href="https://upvent.codes">https://upvent.codes</a>, a menos que se defina lo contrario en esta Política de privacidad.
    </p>
    ...
    <p class="text-muted small">
        Podemos emplear a empresas e individuos de terceros debido a las siguientes razones:
            ...
            <li>Para realicar servicios relacionados con el servicio; o</li>
