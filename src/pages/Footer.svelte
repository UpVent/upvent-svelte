...
<footer class="text-center text-muted bg-light-gray">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="m-2">
                            <a href="/blog" class="text-decoration-none link-dark">Blog</a>
                        </li>
                        <li class="m-2">
                            <a href="/about" class="text-decoration-none link-dark">Nosotros</a>
                        </li>
                        <li class="m-2">
    ...
    <section class="container mt-5 mb-5 text-center-p-4 text-dark">
        <p>El <a class="text-decoration-none link-dark" rel="nofollow" href="https://github.com/UpVent/upvent-svelte">código fuente</a> de esta página se encuentra bajo la <a class="text-decoration-none link-dark" href="https://www.gnu.org/licenses/agpl-3.0.html">Licencia Pública General de Affero (GNU) versión 3</a>. Excepto donde se indique lo <a class="text-decoration-none link-dark" href="https://creativecommons.org/policies#license">contrario</a>, el trabajo escrito, blogs, opiniones y parte del contenido visual se encuentra bajo la <a class="text-decoration-none link-dark" href="https://creativecommons.org/licenses/by-nd/3.0/deed.es">Licencia Creative Commons Atribución-SinDerivadas 3.0 No portada (CC BY-ND 3.0)</a></p>
    </section>
